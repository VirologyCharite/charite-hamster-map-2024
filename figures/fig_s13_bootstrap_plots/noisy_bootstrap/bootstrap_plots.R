...
# neut <- read.acmap('data/220909-hamster/map-titers-continuous-fixbottom-prnt90-adapted.ace')
...
# Plot the figure
png("figures/noisy_bootstrap/bootstrap_plots_240123.png", width = 10, height = 5, units = 'in', res=300, pointsize = 18)
